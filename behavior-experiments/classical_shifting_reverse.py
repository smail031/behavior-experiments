...
# -*- coding: utf-8 -*-
"""
Created on Tue March 16 16:57:22 2021
...
#create tones
low_freq_single_pulse = core.tones(low_freq, sample_tone_length, single_pulse_length) #1000Hz single pulse
low_freq_multi_pulse = core.tones(low_freq, sample_tone_length, multi_pulse_length) #1000Hz multi pulse
high_freq_single_pulse = core.tones(high_freq, sample_tone_length, single_pulse_length) #4000Hz single pulse
high_freq_multi_pulse = core.tones(high_freq, sample_tone_length, multi_pulse_length) #4000Hz multi pulse
...
tone_L_A = low_freq_single_pulse #assign tones
tone_L_B = high_freq_single_pulse
tone_R_A = low_freq_multi_pulse
tone_R_B = high_freq_multi_pulse
