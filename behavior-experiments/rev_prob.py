...
protocol_description = ('In this protocol, one of 2 cues (differing based'
...
rule = core.Rule(n_trials, [highfreq, lowfreq], left_port, criterion,
                 countdown_start, countdown=countdown)
...
for trial in trials:
    ...
    time.sleep(2)
    # Insert marker into imaging data to indicate trial start.
    if ttl_experiment == 'y':
        TTL_marker.pulse()
    ...
    data.loc[trial] = tone.loc  # tone location
